...
func TestValidateCreateColumnType(t *testing.T) {
	tests := []struct {
		...
		{name: "empty user_id", mutate: func(r *tablesv1.CreateColumnTypeRequest) { r.UserExternalId = "" }, wantField: "user_id"},
		{name: "malformed user_id", mutate: func(r *tablesv1.CreateColumnTypeRequest) { r.UserExternalId = "not-a-uuid" }, wantField: "user_id"},
		{name: "user_id without dashes", mutate: func(r *tablesv1.CreateColumnTypeRequest) { r.UserExternalId = "00000000000040008000000000000001" }, wantField: "user_id"},
	}
...
func TestValidateUpdateColumnTypeById(t *testing.T) {
	tests := []struct {
		...
		{name: "empty user_id", mutate: func(r *tablesv1.UpdateColumnTypeByIdRequest) { r.UserExternalId = "" }, wantField: "user_id"},
		{name: "malformed user_id", mutate: func(r *tablesv1.UpdateColumnTypeByIdRequest) { r.UserExternalId = "not-a-uuid" }, wantField: "user_id"},
		{name: "user_id without dashes", mutate: func(r *tablesv1.UpdateColumnTypeByIdRequest) { r.UserExternalId = "00000000000040008000000000000001" }, wantField: "user_id"},
	}
